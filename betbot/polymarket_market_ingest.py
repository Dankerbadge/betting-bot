    ...
    if snapshot_dir_path is not None:
        ...
        if coldmath_refresh_from_api and str(coldmath_wallet_address or "").strip():
            coldmath_snapshot = run_coldmath_snapshot_summary(
                ...
                refresh_closed_positions_from_api=coldmath_refresh_closed_positions_from_api,
                closed_positions_page_size=coldmath_closed_positions_page_size,
                closed_positions_max_pages=coldmath_closed_positions_max_pages,

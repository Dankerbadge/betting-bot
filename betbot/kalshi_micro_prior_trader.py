...
def run_kalshi_micro_prior_trader(
    *,
    ...
    summary = {
        ...
        "execution_empirical_fill_model_lookback_days": max(
            0.0, float(execution_empirical_fill_model_lookback_days)
        ),
        "execution_empirical_fill_model_recent_events": max(
            1, int(execution_empirical_fill_model_recent_events)
        ),
        "execution_empirical_fill_model_min_effective_samples": max(
            1.0, float(execution_empirical_fill_model_min_effective_samples)
        ),
        "execution_empirical_fill_model_prefer_empirical": bool(

...
SERVICE_NAME="betbot-temperature-breadth-worker"
ENV_FILE="/etc/betbot/temperature-shadow.env"
SERVICE_FILE="/etc/systemd/system/${SERVICE_NAME}.service"
RUN_SCRIPT="$REPO_DIR/infra/digitalocean/run_temperature_breadth_worker.sh"
...
[Unit]
Description=BetBot temperature breadth expansion worker

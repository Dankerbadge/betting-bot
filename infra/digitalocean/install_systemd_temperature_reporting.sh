...
SERVICE_NAME="betbot-temperature-reporting"
TIMER_NAME="${SERVICE_NAME}.timer"
ENV_FILE="/etc/betbot/temperature-shadow.env"
SERVICE_FILE="/etc/systemd/system/${SERVICE_NAME}.service"
TIMER_FILE="/etc/systemd/system/${TIMER_NAME}"
RUN_SCRIPT="$REPO_DIR/infra/digitalocean/run_temperature_readiness_reports.sh"
...
[Unit]
Description=BetBot temperature readiness reports
...
[Unit]
Description=Run BetBot temperature readiness reports every $INTERVAL

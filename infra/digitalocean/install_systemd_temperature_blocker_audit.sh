...
SERVICE_NAME="betbot-temperature-blocker-audit"
TIMER_NAME="${SERVICE_NAME}.timer"
ENV_FILE="/etc/betbot/temperature-shadow.env"
SERVICE_FILE="/etc/systemd/system/${SERVICE_NAME}.service"
TIMER_FILE="/etc/systemd/system/${TIMER_NAME}"
RUN_SCRIPT="$REPO_DIR/infra/digitalocean/run_temperature_blocker_audit.sh"
...
[Unit]
Description=BetBot weekly blocker audit (top non-approved reasons)
...
[Unit]
Description=Run BetBot blocker audit every $INTERVAL
